        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6 wow fadeInLeft" data-wow-offset="200" data-wow-delay="200ms">
                    ...
                    <!-- Contact form -->
                    <form name="contact-form" method="post" action="/contacto" class="contact-form" id="contact-form">
@csrf
                        <div class="row">
                            <div class="col-md-6">
                        ...
                        <div class="outer required">
                            <div class="form-group af-inner has-icon">
                                ...
                                <input
                                    type="text" name="titulo" id="subject" placeholder="Subject" value="" size="30"
                        ...
                        <div class="outer required">
                            <div class="form-group af-inner">
                                <input type="submit" name="submit" class="form-button form-button-submit btn btn-block btn-theme ripple-effect btn-theme-dark" id="submit_btnn" />
                            </div>
                        </div>
