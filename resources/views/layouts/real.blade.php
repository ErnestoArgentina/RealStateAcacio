                            ...
                            <div class="swiper-wrapper">
                                <div class="swiper-slide">
                                    ...
                                    <ul class="nav sf-menu">
                                        ...
                                        {{--                                                <li><a href="/listing">Hot Deals</a></li>--}}
                                        <li><a href="/listing">Propriedades</a></li>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <p class="btn-row text-center">
                            <a href="#" class="btn btn-theme ripple-effect btn-icon-left facebook wow fadeInDown"
                               data-wow-offset="20" data-wow-delay="100ms"><i class="fa fa-facebook"></i>FACEBOOK</a>
                            <a href="#" class="btn btn-theme btn-icon-left ripple-effect twitter wow fadeInDown"
                               data-wow-offset="20" data-wow-delay="200ms"><i class="fa fa-twitter"></i>TWITTER</a>
                            <a href="#" class="btn btn-theme btn-icon-left ripple-effect pinterest wow fadeInDown"
                               data-wow-offset="20" data-wow-delay="300ms"><i class="fa fa-pinterest"></i>PINTEREST</a>
                            <a href="#" class="btn btn-theme btn-icon-left ripple-effect google wow fadeInDown"
                               data-wow-offset="20" data-wow-delay="400ms"><i class="fa fa-google"></i>GOOGLE</a>
                        </p>
                        <div class="copyright">&copy; 2015 Real Estate — Real Estate Theme made with passion by jThemes
                            Studio
                        </div>
                    </div>
...
<script>
    @if(session("success")!=null)
        Swal.fire('alerta', '{{session("success")}}', 'success')
    @endif
</script>
